...
문서 기록상 ACT v1·v2·v2.1·v2.2 학습은 이미 완료됐지만, 체크포인트 파일은 인수인계 저장소에 포함되지 않았습니다. 기존 체크포인트가 남아 있다면 원래 학습에 사용한 Mac의 `outputs/train/act_pick_v*/checkpoints/`에서 가져와야 하며, 확보하지 못하면 데이터 재생성 후 다시 학습합니다.
