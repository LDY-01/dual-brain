...
종합 추천은 **6cm**입니다. 8cm가 성공한 경우의 중심 오차는 0.16cm 더 작았지만, 6cm가 안정 성공률과 전체 평균 포함률에서 가장 좋았습니다. 4~5cm는 테이블과 가까워질수록 블록을 누르거나 밀 가능성이 커지며 중심 오차가 증가했습니다. 기본 `place()` 높이는 작업자 승인 후 12cm에서 6cm로 변경합니다.
